...
template = "bfe"  # "ind_cancel"  # "imp_match"  # "kent"  # 
param_file = None  # "params/ind_cancel_params_251029.txt"  # "params/imp_match_params_250703.txt"  # "params/kent_params_250513.txt"  # 
variation = "None"  # "voltage_source_rout_special"  # "couple_out_rout_parallel"  # "basic_match"  # _resonant"  # "voltage_source_output"  # None  # 
...
if original_params:  # does not change time scale, i1_freq/mag
    if template == "imp_match":
        ...
        l2 = cd.params["l2_mag"]
        k = cd.params["k1_mag"]
        kin = cd.params["kin_mag"]
        kout = cd.params["kout_mag"]
        lin = cd.params["lin_mag"]
        lout = cd.params["lout_mag"]
        lj0 = calc_lj(ics)
        lj = lj0  # calc_lj(ics)
    else:
        icr = cd.params["icrit_mag"]
...
def find_c_offset(omega, i1, rin, rout, k0=kin, k0_=kout, l0=lin, l0_=lout, c0=cd.params["c1_mag"]):
    # i1=cd.params["i1_mag"], rout=cd.params["r2_mag"], rin=cd.params["r1_mag"]
